...
#endif
extern int	VideoQualityResult;
#define		VideoQuality VideoQualityResult								//¼v¤ùÀ£ÁY²v

CAviFile:: CAviFile(LPCWSTR lpszFileName /* =_T("Output.avi") */, 
...
HRESULT CAviFile::InitMovieCreation(int nFrameWidth, int nFrameHeight, int nBitsPerPixel)
{
	...
	m_AviStreamInfo.dwSuggestedBufferSize = nMaxWidth*nMaxHeight*3;
	...
	m_AviCompressOptions.dwQuality= VideoQuality;
